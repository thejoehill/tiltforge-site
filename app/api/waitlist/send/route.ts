      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#111;border:1px solid #222;border-radius:12px;overflow:hidden">
        <tr>
          <td style="background:#0d0d0d;border-bottom:1px solid #1a1a1a;padding:36px 40px;text-align:center">
            <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/tiltForge%20logo%20dark-2Re7fY8aYvO7z3WUd7jbJWeu8NxIao.png" alt="TiltForge" width="240" style="display:block;margin:0 auto;max-width:240px;height:auto" />
          </td>
        </tr>
        <tr>
